...
export async function GET(request: NextRequest) {
  try {
    ...
    console.error('Error in GET /api/iptv/servers:', error);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.error('Error in POST /api/iptv/servers:', error);
    return NextResponse.json(
      { 
        success: false, 
...
export async function PUT(request: NextRequest) {
  try {
    ...
    console.error('Error in PUT /api/iptv/servers:', error);
    return NextResponse.json(
      { 
        success: false, 
...
export async function DELETE(request: NextRequest) {
  try {
    ...
    console.error('Error in DELETE /api/iptv/servers:', error);
    return NextResponse.json(
      { success: false, error: 'Internal server error' },
      { status: 500 }
    );
